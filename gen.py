...
if os.path.exists('lasttrain.json'):
    ...
    lt_faq = [
     ...
     ('為什麼末班車的時刻，跟我在換乘 App 上查到的不一樣？',
      ...
      '還有一種換乘 App 不會提醒你的：在關西、福岡和中部，廉航落地的那一棟根本沒有車站，'
      '要先算上接駁巴士，而接駁巴士往往比電車早收班。'),
     ('羽田跟成田，紅眼票該選哪個？',
     ...
     ('這些時刻多久會變一次？',
      ...
      '南海是 2024-12-21 現在、福岡市地下鐵是 2026-04-01 改正、名鐵是 2026-09-23 現在，'
     ...
     ('為什麼只有這五個機場？',
      '因為只查到這五個。新千歲與那霸都還沒查，列在頁尾的待查清單裡。'
      '與其抄第三方整理，不如先空著。'),
    ]
    ...
    lt_title = '日本機場末班車：羽田、成田、關西、福岡、中部落地後還回得去市區嗎'
    lt_desc = ('紅眼班機落地之後的末班車時刻，五個機場逐班對過官方時刻表。羽田京急 00:08 到品川；'
               '成田最後一班直達市區的是 23:03 的 Skyliner；關西 JR 末班只到日根野；'
    ...
    write('japan-airport-last-train/index.html',
      ...
      + f'<div class="today"><div class="tday">羽田與成田的末班車，逐班對過官方時刻表，'
        ...
        f'比名鐵末班早了一小時四十六分。這三個機場，決定你回不回得去的是接駁車，不是電車。</div></div>'
      + '<h2>怎麼用這張表</h2>'
