...
if os.path.exists('apple.json'):
    ...
    faq=[
     ...
     ('直接飛過去到 Apple Store 店頭買得到嗎？',
      '新機已經不行。Apple 自 2026 年 2 月 6 日起停止日本直營店的 iPhone 旗艦機種現場現貨販售，'
      '即使店內有貨也不接受臨櫃購買，必須透過官網或 Apple Store App 下單，再選擇配送或到店取貨，'
      '這是針對轉售的管制措施。因此對旅客而言，實務上可行的是 Bic Camera、Yodobashi 等家電量販店，'
      '而那也正好是唯一還能免稅的通路。'),
